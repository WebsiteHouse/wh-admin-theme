...
Material Design inspired admin theme with a black and gold colour scheme. Add your own custom logo to match your website.

== Description ==

A Material Design inspired black and gold colour scheme for WordPress Admin (v4.0 onwards). Used by [Design by Mito](https://designbymito.com/) for client websites, Aquila also cleans up the admin area from unnecessary or potentially confusing items.
...
2. Aquila Dashboard.
3. Aquila Settings page with custom logo.
4. Edit page.
...
* Tweaked colour scheme to Google's Material Design spec.
